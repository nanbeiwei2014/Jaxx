...
HDWalletPouchDash.uiComponents = {
    ...
    pageDisplayPrivateKeysName: 'backupPrivateKeysDash',
...
HDWalletPouchDash.prototype.sendDashTransaction = function(transaction, callback) {
  ...
  /*  this._pouchManager._transactions[txid] = mockTx;
    ...
    RequestSerializer.postJSON(requestUrl, dataToSend, function(data, status, passThrough) {
        ...
        self._pouchManager._dataStorageController.registerSentTransaction({sent:transaction,result:data});
...
*/
    ...
    g_JaxxApp.getRelays(COIN_DASH).startRelayTaskWithBestRelay('pushRawTx', [transaction.toHex(), function (response, result){
...
HDWalletPouchDash.prototype.processFinishedFinalBalanceUpdate = function() {

}

HDWalletPouchDash.isValidPrivateKey = function(value){
    return isValidBTCPrivateKey(value, HDWalletPouchDash.networkDefinitions.mainNet);
}

HDWalletPouchDash.prototype.sendTransaction = function(signedTransaction, callback, params, debugIdx){
    this.sendDashTransaction(signedTransaction, callback);
}