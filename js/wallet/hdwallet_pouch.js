...
if(isNaN(index)){
   ...
   // console.log('internal '+ internal + ' index '+ index)
    ...
    if (internal){
        ...
        publicAddress = this._dataStorageController.getAddressReceive(index);
    }
...
HDWalletPouch.prototype.convertFiatToCoin = function(fiatAmount, coinUnitType, fiatUnit){
    // @TODO: refactor so that method signature for pouch and pouch implementations match
    return this.getPouchFoldImplementation().convertFiatToCoin(fiatAmount, coinUnitType, fiatUnit);
}
