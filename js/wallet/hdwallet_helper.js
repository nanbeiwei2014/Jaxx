...
//    this._coinHDTypeTestnetOffset[COIN_ETHEREUM] = 131337;
    ...
    this.unitsOfEther = new thirdparty.Big('1000000000000000000');
...
HDWalletHelper.cryptoCurrenciesAllowed = {
    ...
    "ios": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": true, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE": true, "ICN": true, "GNT": true, "GNO": true, "SNGLS": false, "DGD": true, "BCAP": false, "CVC": false}
}
...
HDWalletHelper.privateKeyCryptoCurrenciesAllowed = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE":true, "ICN": false, "GNT": false, "GNO": false, "SNGLS": false, "DGD": false, "BCAP": false, "CVC": false},
    "ios": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE":true, "ICN": false, "GNT": false, "GNO": false, "SNGLS": false, "DGD": false, "BCAP": false, "CVC": false}
}

HDWalletHelper.paperWalletsCryptoCurrenciesAllowed = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": false, "DOGE": false, "ICN": false, "GNT": false, "GNO": false, "SNGLS": false, "DGD": false, "BCAP": false, "CVC": false},
    "ios": {"BTC": true, "ETH": true, "DAO": false, "DASH": false, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": false, "SBTC": false, "DOGE": false, "ICN": false, "GNT": false, "GNO": false, "SNGLS": false, "DGD": false, "BCAP": false, "CVC": false}
}
...
HDWalletHelper.prototype.initialize = function() {
  ...
  //  console.log("[ HDWallet Helper Initialize ]");
   ...
   // console.log('AAA', this._exchangeRates, this.dictFiatCurrency);
...
//        console.log("_updateExchangeRateTime :: " + this._updateExchangeRateTime);
  ...
  //  console.log('BBB', this._exchangeRates);

    this._loadExchangeRates();
    setInterval(function() {
        self._updateExchangeRates();
      //  console.log('CCC', self._exchangeRates);
        //console.log('CCC', self.dictFiatCurrency);
...
HDWalletHelper.prototype._updateExchangeRates = function(){
    ...
    var url1 = 'https://utils.jaxx.io/api/exchange/global';
   // var url1 = 'https://apiv2.bitcoinaverage.com/ticker/global/all'

   // console.error(url1);

    RequestSerializer.getJSON(url1, function (tickerData) {
      ...
      //  var url = "https://poloniex.com/public?command=returnTicker";
       // var url = "http://52.35.71.149:49599/api/exchange/legacy";
        var url = "https://utils.jaxx.io/api/exchange/legacy/";



        RequestSerializer.getJSON(url, function (tickerData) {
...
//                console.log('Exchange Rate Log :: _updateExchangeRates called and inside loop with coinType: ' + coinTypeCounter);
                if (coinTypeCounter === COIN_BITCOIN) {
                    ...
                    if (coinTypeCounter === COIN_THEDAO_ETHEREUM) {
                      ...
                      // console.log(tickerName);
                        ...
                        if (!tickerData || !tickerData[tickerName] || !tickerData[tickerName].last) {
                         ...
                         //   console.error( ' no data for  ' + tickerName, tickerData[tickerName]);
                    //_____________________________        console.log("error :: to get exchange rates for :: " + coinTypeCounter);
                        ...
                        var usdRate = self._exchangeRates[COIN_BITCOIN]['USD'].last;



                        var btcToCoin = tickerData[tickerName].last;

                      // var CoinToUsd = tickerData[tickerName].last;

                      //  var coinToUsd = btcToCoin;// (usdRate * btcToCoin).toFixed(2);



                       // console.log(btcToCoin)

                        var didUpdateRates = true;
                          ...
                          //  didUpdateRates = true;
                            ...
                            for (var currency in self._exchangeRates[COIN_BITCOIN]) {
                               ...
                               // tempRate['bid'] = (self._exchangeRates[COIN_BITCOIN][currency]['bid'] * btcToCoin).toFixed(8);
                                ...
                                tempRate['last'] = (self._exchangeRates[COIN_BITCOIN][currency]['last'] * btcToCoin / usdRate).toFixed(8);
                               ...
                               // }
                              //  console.log(coinTypeCounter, currency, btcToCoin, usdRate, tempRate.last);
...
HDWalletHelper.prototype._loadExchangeRates = function() {
    ...
    if (typeof(exchangeRates) !== 'undefined' && exchangeRates !== null) {
        ...
        console.log('   numExistingExchangeData   ' +numExistingExchangeData)
...
HDWalletHelper.convertWeiToEther = function(wei) {
    ...
    if(wei > 0) {
        ...
        var balance = new thirdparty.Big(self.convertWeiToEtherCache.Wei);
...
HDWalletHelper.convertEtherToWei = function(ether) {
    ...
    var balance =  new thirdparty.Big(self.converEtherToWeiCache.ether); 
...
HDWalletHelper.prototype.convertEthereumLikeSmallUnitToFiat = function(coinType, wei, fiatUnit, noPrefix) {
   ...
   // console.log('coinType, wei, fiatUnit, noPrefix ',coinType, wei, fiatUnit, noPrefix);
    baseFiatDict.noPrefix = noPrefix;
   ...
   // console.log('baseFiatDict.fiatUnit  ' + baseFiatDict.fiatUnit  +  '   rate  '+ rate, this._exchangeRates[coinType]);
...
//    console.log("HDWalletHelper :: convertEthereumLikeSmallUnitToFiat :: fiatUnit :: " + fiatUnit + " :: noPrefix :: " + noPrefix + " :: wei :: " + wei + " :: value :: " + value);
    ...
    ///console.log('convertFiatValueToInternational  value  '+ value + '   baseFiatDict  ', baseFiatDict);
...
HDWalletHelper.convertCoinToUnitType = function(coinType, coinAmount, coinUnitType) {
   ...
   // console.log(coinType, coinAmount, coinUnitType);
    //@note: @here: @token: this seems necessary.
    if (coinType === COIN_BITCOIN) {
...
//        console.log("convert :: " + coinAmount + " :: " + coinOtherUnitAmount)
        ...
        coinType === COIN_AUGUR_ETHEREUM || coinType === COIN_GOLEM_ETHEREUM || coinType === COIN_GNOSIS_ETHEREUM || coinType === COIN_ICONOMI_ETHEREUM ||
        coinType === COIN_SINGULARDTV_ETHEREUM || coinType === COIN_BLOCKCHAINCAPITAL_ETHEREUM ||
        coinType === COIN_CIVIC_ETHEREUM
    ) {
        coinOtherUnitAmount = (coinUnitType === COIN_UNITLARGE) ? HDWalletHelper.convertWeiToEther(coinAmount) : HDWalletHelper.convertEtherToWei(coinAmount);
...
//        coinOtherUnitAmount = (coinUnitType === COIN_UNITLARGE) ? HDWalletHelper.convertSatoshisToBitcoins(coinAmount) : HDWalletHelper.convertBitcoinsToSatoshis(coinAmount);
   ...
   // console.log('coinOtherUnitAmount  ' + coinOtherUnitAmount)
