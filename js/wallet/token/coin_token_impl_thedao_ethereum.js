...
CoinTokenTheDAOEthereum.prototype.createTransaction = function(address, depositAddresses, amount) {
    ...
    // Sample test cases:
    // wallet.getPouchFold(1).getToken(0).getPouchFoldImplementation().createTransaction("0x25040290d7Ed172C74A0CcAE37E09B413C26155B", [], 30000)
    // wallet.getPouchFold(1).getToken(0).getPouchFoldImplementation().createTransaction("0x25040290d7Ed172C74A0CcAE37E09B413C26155B", ["0x25040290d7Ed172C74A0CcAE37E09B413C26155B"], 30000)
...
CoinTokenTheDAOEthereum.prototype.getBaseCoinAddressFormatType = function() {
