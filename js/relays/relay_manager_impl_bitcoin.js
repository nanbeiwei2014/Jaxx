...
RelayManagerBitcoin.prototype.initialize = function(arrRelayNodes) {
    ...
    if (typeof(arrRelayNodes) !== 'undefined' && arrRelayNodes !== null){
        ...
        this._relayNodes = [
           ...
           new BTCBlockrRelay() // We prioritize this one because one call can be made for all balances
...
RelayManagerBitcoin.prototype.setRelayNodes = function(arrNodes){
