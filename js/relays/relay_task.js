...
RelayTask.prototype.isCallbackSuccessful = function(status) {
  ...
  this._relayManager.relayLog(this);
  return this._isCallbackSuccessfulFunction.apply(this, arguments);
}

RelayTask.prototype.isCallbackPermanentFailure = function(status) {
	//return this._isCallbackPermanentFailureFunction(status);
  if (typeof(this._relayManager.getRelayByIndex(this._currentRelayIndex)._name) !== "undefined" && this._relayManager.getRelayByIndex(this._currentRelayIndex)._name !== null){
      console.log("%c Relay Call Failed :: " + this._relayManager.getRelayByIndex(this._currentRelayIndex)._name + " :: " + this._relayFunctionName, 'color:red');
      console.log(arguments);
  }
  return this._isCallbackPermanentFailureFunction.apply(this, arguments);
}
...
RelayTask.prototype.attachRelayManager = function(relayManager){
    this._relayManager = relayManager;
}

RelayTask.prototype.getRelayManager = function(){
