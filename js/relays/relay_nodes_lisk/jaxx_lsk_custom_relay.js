var LSKJaxxCustomRelay = function() {
    this._baseUrl = "https://api.jaxx.io/api/lsk/";
    this._name = "Jaxx Lisk Custom API";
    this._reliable = "true";
    this._lastBlock = 0;
...
LSKJaxxCustomRelay.prototype.initialize = function(relayManager) {
    this._relayManager = relayManager;
}

LSKJaxxCustomRelay.prototype.isForceThisRelayToFail = function(){
    return this._forceThisRelayToFail;
}

LSKJaxxCustomRelay.prototype.getLastBlockHeight = function(){
    // This function shares a common interface with the other relays.
    return this._lastBlock;
}

LSKJaxxCustomRelay.prototype.setLastBlockHeight = function(newHeight){
    this._lastBlock = newHeight;
}

LSKJaxxCustomRelay.prototype.fetchLastBlockHeight  = function(callback, passthroughParams) {
    ...
    RequestSerializer.getJSON(this._baseUrl + 'blockchainInfo', function(response, status, passthroughParams) {
        if (status === 'error'){
            ...
            self.setLastBlockHeight(response.totalBlocks);
...
LSKJaxxCustomRelay.prototype.checkCurrentHeightForAnomalies  = function() {
...
LSKJaxxCustomRelay.prototype.getTxList = function(addresses, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.getTxListParse = function(primaryTxDetailData, passthroughParams) {
...
LSKJaxxCustomRelay.prototype.getTxCount = function(addresses, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.getTxDetails  = function(txHashes, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.getTxDetailsParse = function(primaryTxDetailData) {
...
LSKJaxxCustomRelay.prototype.getAddressBalance = function(address, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.getFixedBlockHeight = function(address, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.getUTXO  = function(address, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.pushRawTx = function(hex, callback, passthroughParams) {
    if (this._forceThisRelayToFail) {
...
LSKJaxxCustomRelay.prototype.getRelayType = function() {
    return 'LSKJaxxCustomRelay';
}

LSKJaxxCustomRelay.prototype.getRelayTypeWithCallback = function(callback) {
    var relayName = 'LSKJaxxCustomRelay';
    callback("success", relayName);
    return relayName; 
}

LSKJaxxCustomRelay.prototype.getRelayTypeWithCallbackForgettingStatus = function(callback) {
    var relayName = 'LSKJaxxCustomRelay';
    callback(relayName);
    return relayName; 
}
...
if (typeof(exports) !== 'undefined') {
    exports.relayBlockExplorer = LSKJaxxCustomRelay;
}