...
module jaxx {
    ...
    export class JaxxAccountService {
        ...
        constructor(settings: any, db: jaxx.JaxxDatastoreLocal, config: any) {
            ...
            let options =  _.extend(config, settings);
       ...
       /* getMiningFees(): number {
        ...
        createNewWallet(): void {
            ...
            let addressReceive = this.is_Token?Registry.Ethereum.getAddressReceive(0):this.getAddressReceive(0);
