...
JaxxUIIntro.prototype.toggleExpandSetupOption = function(strSetupOption){
    ...
    g_JaxxApp.getUI().toggleTextExpansion('.settings.createNewWallet .btnOpenClose' + strSetupOption, '.settings.createNewWallet .btnOpenClose' + strSetupOption + ' .triangleArrow','125px', '60px', 500);
}
...
JaxxUIIntro.prototype.setConfirmPinCirclesToRedBorder = function(){    
    ...
    $('.confirmPinCodeCustomIntroOption .settingsEnterPinPad input').css('color', '#FF0000 !important');
}
...
JaxxUIIntro.prototype.setConfirmPinCirclesToBlueBorder = function(){
    ...
    $('.confirmPinCodeCustomIntroOption .settingsEnterPinPad input').css('color', '#07630B !important');
}
