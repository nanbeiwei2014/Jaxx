...
var jaxx;
(function (jaxx) {
    var TransactionsToken = (function () {
        function TransactionsToken(controller) {
            var _this = this;
        ...
        TransactionsToken.prototype.logNonces = function () {
            console.log('%c nonces', 'color:red');
            for (var str in this.nonces)
                console.log(str + ' ' + this.nonces[str]);
        };
        ///////////////////////////////////////////////////////////////////////////////
        TransactionsToken.prototype.onSendTransactionStart = function (data) {
            data.name = this.name;
            console.log(this.name + ' transaction start ', data);
        };
        TransactionsToken.prototype.registerSentTransaction = function (data) {
            // console.error(data);
            var _this = this;
            ...
            var txid = data.sent._kkMockTx.txid;
        ...
        TransactionsToken.prototype.createBalanceTempBitcoin = function (input) {
        ...
        TransactionsToken.prototype.getBalancesTempFromTransaction = function (sent) {
            var ar = sent.inputs;
            var indexed = {};
        ...
        TransactionsToken.prototype.sendTransactionController = function (sent) {
            //console.log(sent);
        ...
        TransactionsToken.prototype.updateUTXOS = function (utxos) {
            this.utxos = jaxx.Utils.updateUTXOS(this.utxos, utxos);
            this.toSaveTempUTXOs = true;
        };
        TransactionsToken.prototype.loadUnconfirmedTransactions = function () {
            var uncofirmed = this.getUTXOs().filter(function (item) {
                return item.inqueue;
            });
        };
        TransactionsToken.prototype.sartCheckUTXOS = function () {
            var _this = this;
        ...
        TransactionsToken.prototype.addUTXO = function (utxo) {
            this.utxos.push(utxo);
        };
        TransactionsToken.prototype.remapUTXOs = function (utxos) {
        ...
        TransactionsToken.prototype.remapTransactionsToOldCode = function (unspent) {
            var out = [];
            var indexed = {};
        ...
        TransactionsToken.prototype.downloadUTXOs = function (callBack) {
            var _this = this;
        ...
        TransactionsToken.prototype.getUTXOsInQueue = function () {
            return this.getUTXOs().filter(function (item) {
                return item.inqueue;
            });
        };
        TransactionsToken.prototype.getUTXOsNotInQueue = function () {
            return this.getUTXOs().filter(function (item) {
                return !item.inqueue;
            });
        };
        TransactionsToken.prototype.getUTXOs = function () {
            return jaxx.Utils.deepCopy(this.utxos) || [];
        };
        ////////////////////////////// en of Bitcoin ///////////////////////////////////////////
        TransactionsToken.prototype.onNewTransactions = function (transactions) {
            //console.warn('new transactions',transactions);
        };
        //////////////////////////////////////// integration //////////////////////////////
        TransactionsToken.prototype.deactivate = function () {
            this.isActive = false;
            clearInterval(this.saveInterval);
            clearInterval(this.refreshInterval);
            this.downloadingData = null;
        };
        TransactionsToken.prototype.activate = function () {
            var _this = this;
            if (this.isActive)
                return;
            this.isActive = true;
        ...
        TransactionsToken.prototype.refreshData = function () {
            var _this = this;
        ...
        TransactionsToken.prototype.prepareTransactions = function () {
            if (this.name.indexOf('Ethereum') !== -1) {
        ...
        TransactionsToken.prototype.reset = function () {
            this.db.saveNonces({});
            this.db.saveUTXOs([]);
        ...
        ////////////////////////////////////// Ethereum //////////////////////////////////////////////////////
        TransactionsToken.prototype.createBalanceTempEther = function (tr, txid) {
        ...
        TransactionsToken.prototype.downloadNonceForFirstAddress = function () {
            var _this = this;
        ...
        TransactionsToken.prototype.downloadNonce = function (callBack) {
            var _this = this;
            if (this.downloadingData)
                return;
        ...
        TransactionsToken.prototype.getNonces = function (orig) {
            return orig ? this.nonces : _.clone(this.nonces);
        };
        TransactionsToken.prototype.addTempNonce = function (balance) {
        ...
        TransactionsToken.prototype.getNonceForAddress = function (address) {
            return this.nonces[address] || 0;
        };
        //sortedHighestAccountArray:{index:number, balance:number, address:string}[] = [];
        TransactionsToken.prototype.getHighestAccountBalanceAndIndex = function () {
        ...
        TransactionsToken.prototype.prepareAddresses = function (addresses) {
            var deferred = $.Deferred();
            deferred.resolve(this.nonces);
            return deferred;
        };
        return TransactionsToken;
    }());
    jaxx.TransactionsToken = TransactionsToken;
})(jaxx || (jaxx = {}));
//# sourceMappingURL=transactions-token.js.map