...
(function (jaxx) {
    ...
    var TokenService = (function () {
        function TokenService(settings, db, options) {
            this.onTransaction$ = $({});
            //////////////////////////
        ...
        TokenService.prototype.stop = function () {
        };
        /* getMiningFees(): number {
         return this.request.getMiningFees();
         }*/
        TokenService.prototype.getMiningFees = function () {
            return this.crypto_class.getMiningFees();
        };
        //////////////////////////////////////    Generator
        TokenService.prototype.addKeyPairToBalances = function (balances, change_receive) {
            var _this = this;
            var i;
        ...
        TokenService.prototype.getKeyPairReceive = function (index) {
            return this.crypto_class.generator.generateKeyPairReceive(index);
        };
        TokenService.prototype.getKeyPairChange = function (index) {
            return this.crypto_class.generator.generateKeyPairChange(index);
        };
        TokenService.prototype.getCurrentAddressReceive = function () {
        ...
        TokenService.prototype.getCurrentAddressChange = function () {
            return this._db.getCurrentAddressChange();
        };
        TokenService.prototype.getAddressReceive = function (index) {
            if (this.is_Token)
        ...
        TokenService.prototype.getAddressChange = function (index) {
        ...
        TokenService.prototype.getAddress = function (index, receive_change) {
            var address;
        ...
        TokenService.prototype.createNewWallet = function () {
        ...
        TokenService.prototype.goToNextIndexChange = function () {
        ...
        TokenService.prototype.goToNextIndexReceive = function () {
        ...
        //////////////////////////////////////////////
        TokenService.prototype.initTokenData = function () {
            var _this = this;
        ...
        TokenService.prototype.onError = function (err) {
            console.error(err);
            this.errors.push(err);
            if (this.errors.length > 1000)
                this.errors.shift();
        };
        TokenService.prototype.restoreHistory = function (receive_change) {
        ...
        TokenService.prototype.restoreHistory2 = function (receive_change, startIndex) {
        ...
        TokenService.prototype.restoredHistoryReceive = function (callBack) {
        ...
        TokenService.prototype.restoreHistoryChange = function (callBack) {
            var _this = this;
            var start = Date.now();
        ...
        TokenService.prototype.restoreHistoryAll = function () {
            var _this = this;
            var deferred = $.Deferred();
            if (this.is_Token) {
                this.initTokenData();
        ...
        TokenService.prototype.isContinueNewTranasctions = function (newTransactions) {
        ...
        TokenService.prototype._downloadNewTranasctions = function () {
            var _this = this;
        ...
        TokenService.prototype.onDownloadedNewTransactions = function (transactions) {
            var _this = this;
        ...
        TokenService.prototype.downloadNewTransactions1 = function (addresses) {
            var _this = this;
        ...
        TokenService.prototype.downloadNewTransactions2 = function (addresses) {
        ...
        TokenService.prototype.downloadTransactionsUnspent = function (addresses) {
        ...
        TokenService.prototype.downloadTransactionsForAddress = function (address) {
            return this.crypto_class.downloadTransactionsForAddress(address);
        };
        TokenService.prototype.checkAddressesForTranasactions = function (addresses) {
            return this.crypto_class.checkAddressesForTranasactions(addresses).then(function (result) {
                console.log(result);
                return result;
            });
        };
        TokenService.prototype.downloadTransactionsDetails = function (txsList) {
            return this.crypto_class.downloadTransactionsDetails(txsList);
        };
        TokenService.prototype._checkAddressesBalances = function () {
            var _this = this;
        ...
        TokenService.prototype.startCheckAddressesBalances = function (addresses) {
        ...
        TokenService.prototype.onBalancesDifference = function (diff) {
        ...
        TokenService.prototype.downloadBalancesAll = function (callBack, onError) {
            var _this = this;
            if (this.is_Token) {
                callBack();
                return;
        ...
        TokenService.prototype.downloadBalancesReceive = function (callBack, onError) {
        ...
        TokenService.prototype.downloadBalancesChange = function (callBack, onError) {
