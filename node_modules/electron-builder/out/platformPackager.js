...
class PlatformPackager {
    ...
    doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions, targets) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Packaging for ${platformName} ${(_core || _load_core()).Arch[arch]} using ${isElectron ? `electron ${_this2.info.electronVersion}` : `muon ${muonVersion}`} to ${_path.relative(_this2.projectDir, appOutDir)}`);
