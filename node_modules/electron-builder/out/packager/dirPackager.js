...
function createDownloadOpts(opts, platform, arch, electronVersion) {
    if (opts.download != null) {
        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`"build.download is deprecated — please use build.electronDownload instead`);
    }
...
function subOptionWarning(properties, optionName, parameter, value) {
    if (properties.hasOwnProperty(parameter)) {
        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`${optionName}.${parameter} will be inferred from the main options`);
    }
