...
exports.isMacOsSierra = exports.isOsVersionGreaterThanOrEqualTo = undefined;
...
/** @internal */
let isOsVersionGreaterThanOrEqualTo = exports.isOsVersionGreaterThanOrEqualTo = (() => {
...
let isMacOsSierra = exports.isMacOsSierra = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
        return process.platform === "darwin" && (yield isOsVersionGreaterThanOrEqualTo("10.12"));
    });
...
const macOsVersion = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
