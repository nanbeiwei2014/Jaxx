...
exports.dependencies = exports.readInstalled = undefined;
    ...
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (folder, parent, name, depth, opts, realpathSeen, findUnmetSeen) {
        ...
        const deps = yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map((yield readScopedDir(_path.join(folder, "node_modules"))), (() => {
            var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (pkg) {
                return (0, (_promise || _load_promise()).orNullIfFileNotExist)(_readInstalled(_path.join(folder, "node_modules", pkg), obj, pkg, depth + 1, opts, realpathSeen, findUnmetSeen));
            });
...
let dependencies = exports.dependencies = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (dir, result) {
        const pathToDep = yield readInstalled(dir);
    ...
    return function dependencies(_x11, _x12) {
