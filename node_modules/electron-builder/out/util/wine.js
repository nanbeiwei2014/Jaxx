...
const wineExecutable = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
    if (process.platform === "darwin" && (yield (0, (_macosVersion || _load_macosVersion()).isOsVersionGreaterThanOrEqualTo)("10.12"))) {
    ...
    yield checkWineVersion((0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("wine", ["--version"]));
    return { path: "wine" };
}));
/** @private */
function execWine(file, args) {
    ...
    if (process.platform === "win32") {
        return (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)(file, args, options);
    } else {
        return wineExecutable.value.then(wine => (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)(wine.path, [file].concat(args), wine.env == null ? options : Object.assign({ env: wine.env }, options)));
    }
}
/** @private */
