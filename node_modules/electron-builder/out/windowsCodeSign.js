...
let getToolPath = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
        ...
        if (process.platform === "win32") {
            ...
            let suffix = null;
            try {
                if (yield (0, (_macosVersion || _load_macosVersion()).isOsVersionGreaterThanOrEqualTo)("10.12")) {
...
function _load_bundledTool() {
    return _bundledTool = require("./util/bundledTool");
}

var _macosVersion;

function _load_macosVersion() {
    return _macosVersion = require("./util/macosVersion");
}
