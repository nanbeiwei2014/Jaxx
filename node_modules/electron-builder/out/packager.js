...
class Packager {
    ...
    constructor(options, cancellationToken) {
        ...
        try {
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)("electron-builder " + "19.6.3");
        } catch (e) {
    ...
    build() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const config = yield (0, (_config || _load_config()).getConfig)(projectDir, configPath, devMetadata, configFromOptions);
    ...
    installAppDependencies(platform, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (options.nodeGypRebuild === true) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Executing node-gyp rebuild for arch ${(_core || _load_core()).Arch[arch]}`);
            ...
            if (options.npmSkipBuildFromSource !== true && platform.nodeName !== process.platform) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)("Skip app dependencies rebuild because platform is different");
            } else {
