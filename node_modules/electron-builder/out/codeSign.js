...
let createKeychain = exports.createKeychain = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (_ref4) {
        ...
        const keychainFile = yield tmpDir.getTempFile(".keychain");
...
const bundledCertKeychainAdded = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy(createCustomCertKeychain);
